...
# _check_tp_extension y el loop principal usen el mismo umbral.
...
# no existía, así que siempre usaba -3.0 hardcodeado sin poder cambiarlo.
# MAX_DAILY_LOSS_USDT se conserva para compatibilidad con monitores existentes.
